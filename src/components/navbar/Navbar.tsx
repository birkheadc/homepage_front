...
function Navbar(props: NavbarProps) {
    ...
    const [visibleDropdown, setVisibleDropdown] = useState<string>('contactMe');
        ...
        <div className='nav-wrapper'>
            <nav className='primary-nav' onMouseLeave={handleMouseLeave}>
                ...
                <ul>
                    ...
                    <a data-dropdown='blogsPreview' className='nav-link' href='https://blog.birkheadc.me' onMouseOver={handleChangeDropdown} target="_blank">Blog</a>
